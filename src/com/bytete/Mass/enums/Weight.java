...
public interface Weight {
    BigDecimal STANDARD_TO_BURMESE_PAE_WEIGHT = BigDecimal.valueOf(0.96000000000384);
    ...
    BigDecimal BURMESE_PAE_WEIGHT_TO_STANDARD = BigDecimal.valueOf(1.041666666666625);
